...
CREATE TABLE IF NOT EXISTS `seat` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `type` ENUM('normal', 'pmr', 'stair', 'empty') NOT NULL,
...
CREATE UNIQUE INDEX `unique_seat_per_room` ON `seat` (`room_id` ASC, `seat_letter` ASC, `seat_number` ASC) VISIBLE;
